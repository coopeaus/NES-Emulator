...
#define SDL_WINDOW_LACKS_SHAPE -3
    ...
    /** \brief An enum denoting the specific type of contents present in an SDL_WindowShapeParams
     * union. */
    typedef enum
    {
...
#define SDL_SHAPEMODEALPHA( mode )                                                                 \
    ...
    /** \brief A struct that tags the SDL_WindowShapeParams union with an enum describing the type
     * of its contents. */
