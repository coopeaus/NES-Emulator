...
/* Keep C++ case alone: Some versions of gcc will define __STDC_VERSION__ even when compiling in C++
 * mode. */
...
#define SDL_copyp( dst, src )                                                                      \
    ...
    /* Note that memset() is a byte assignment and this is a 32-bit assignment, so they're not
     * directly equivalent. */
    ...
    extern DECLSPEC int SDLCALL SDL_wcsncmp( const wchar_t *str1, const wchar_t *str2,
                                             size_t maxlen );
    extern DECLSPEC int SDLCALL SDL_wcscasecmp( const wchar_t *str1, const wchar_t *str2 );
    extern DECLSPEC int SDLCALL SDL_wcsncasecmp( const wchar_t *str1, const wchar_t *str2,
                                                 size_t len );
    ...
    extern DECLSPEC int SDLCALL SDL_vsscanf( const char                         *text,
                                             SDL_SCANF_FORMAT_STRING const char *fmt, va_list ap )
    ...
    extern DECLSPEC int SDLCALL SDL_vasprintf( char                               **strp,
                                               SDL_PRINTF_FORMAT_STRING const char *fmt,
