...
#define SDL_Colour SDL_Color
     ...
     */
    extern DECLSPEC SDL_bool SDLCALL SDL_PixelFormatEnumToMasks( Uint32 format, int *bpp,
     ...
     * \sa SDL_MapRGBA
     */
    extern DECLSPEC Uint32 SDLCALL SDL_MapRGB( const SDL_PixelFormat *format, Uint8 r, Uint8 g,
                                               Uint8 b );
     ...
     * \sa SDL_MapRGB
     */
    extern DECLSPEC Uint32 SDLCALL SDL_MapRGBA( const SDL_PixelFormat *format, Uint8 r, Uint8 g,
                                                Uint8 b, Uint8 a );
