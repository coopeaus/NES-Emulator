...
#define SDL_WINDOWPOS_ISCENTERED( X ) ( ( ( X ) & 0xFFFF0000 ) == SDL_WINDOWPOS_CENTERED_MASK )
    ...
    typedef enum
    {
        ...
        SDL_ORIENTATION_LANDSCAPE_FLIPPED, /**< The display is in landscape mode, with the left side
     ...
     * \sa SDL_DestroyWindow
     */
    extern DECLSPEC SDL_Window *SDLCALL SDL_CreateWindow( const char *title, int x, int y, int w,
                                                          int h, Uint32 flags );
     ...
     */
    extern DECLSPEC void SDLCALL SDL_SetWindowMinimumSize( SDL_Window *window, int min_w,
                                                           int min_h );
     ...
     * \sa SDL_SetWindowMinimumSize
     */
    extern DECLSPEC void SDLCALL SDL_SetWindowMaximumSize( SDL_Window *window, int max_w,
                                                           int max_h );
     ...
     * \sa SDL_SetWindowGammaRamp
     */
    extern DECLSPEC int SDLCALL SDL_GetWindowGammaRamp( SDL_Window *window, Uint16 *red,
     ...
     */
    typedef SDL_HitTestResult( SDLCALL *SDL_HitTest )( SDL_Window *win, const SDL_Point *area,
                                                       void *data );
