...
#elif (                                                                                            \
    defined( __APPLE__ ) &&                                                                        \
    ( defined( __arm64__ ) || defined( __aarch64__ ) ) ) /* this might work on other ARM targets,  \
...
#define SDL_assert_always( condition ) SDL_enabled_assert( condition )
     ...
     */
    typedef SDL_AssertState( SDLCALL *SDL_AssertionHandler )( const SDL_AssertData *data,
                                                              void                 *userdata );
     ...
     */
    extern DECLSPEC void SDLCALL SDL_SetAssertionHandler( SDL_AssertionHandler handler,
                                                          void                *userdata );
