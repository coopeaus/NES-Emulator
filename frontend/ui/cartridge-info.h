...
public:
  CartridgeInfoWindow( Renderer *renderer )
      : UIComponent( renderer ), cpu( renderer->bus.cpu ), iNes( renderer->bus.cartridge.iNes ),
        ...
        byte14( iNes.header.fields.miscRoms.value ), byte15( iNes.header.fields.defaultExpansionDevice.value )
  {
    visible = false;
  }
  ...
  */
  ...
  static void InfoBox( ImVec2 size )
  {
    ...
    ImGui::Text( "ROM Header Information"
  ...
  void HeaderInfoRaw( ImVec2 size )
  {
    ...
    ImGui::SameLine();
    ImGui::Indent( outerSpacing );
    HelpMarker( " PRG-RAM/EEPROM size\n D~7654 3210\n ---------\n pppp PPPP\n |||| ++++- PRG-RAM (volatile) "
