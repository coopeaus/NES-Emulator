...
extern "C"
{
     ...
     *  ```
     *
     *  Using the SDL_HINT_GAMECONTROLLERCONFIG hint or the SDL_GameControllerAddMapping() you can
     * add support for controllers SDL is unaware of or cause an existing controller to have a
     ...
     * string for the device and mappings are controller mappings to joystick ones. Under Windows
     * there is a reserved GUID of "xinput" that covers any XInput devices. The mapping format for
     * joystick is: bX - a joystick button, index X hX.Y - hat X with value Y aX - axis X of the
     * joystick Buttons can be used as a controller axis and vice versa.
     *
...
#define SDL_GameControllerAddMappingsFromFile( file )                                              \
     ...
     */
    extern DECLSPEC SDL_GameControllerButtonBind SDLCALL SDL_GameControllerGetBindForAxis(
    ...
    extern DECLSPEC int SDLCALL SDL_GameControllerGetTouchpadFinger(
        SDL_GameController *gamecontroller, int touchpad, int finger, Uint8 *state, float *x,
     ...
     */
    extern DECLSPEC int SDLCALL
    SDL_GameControllerRumbleTriggers( SDL_GameController *gamecontroller, Uint16 left_rumble,
     ...
     * \since This function is available since SDL 2.0.14.
     */
    extern DECLSPEC int SDLCALL SDL_GameControllerSetLED( SDL_GameController *gamecontroller,
